...
import sys
sys.path.append('/home/wuhao/workspace/meta-dataset/')
import json
import os
...
def main(unused_argv):
  ...
  # add relative config search path to gin
  gin.add_config_file_search_path('/home/wuhao/workspace/meta-dataset')
